      ...
      <v-main>
        <v-container>
          <v-card elevation="0" rounded="0" class="mx-auto" width="500">
            <v-card-title class="find_password_title">
              비밀번호 찾기
            ...
            <v-card class="mb-3" color="surface-variant" variant="tonal">
              <v-card-text class="text-medium-emphasis text-caption">
                ...
                다른 사용자가 임의로 초기화 할 수 있으므로 주의를 부탁드립니다.
              </v-card-text>
            </v-card>
            <v-card-actions>
              ...
              >
              <v-spacer></v-spacer>
              <v-btn color="primary" append-icon="mdi-chevron-right" @click="auth.resetPassword"
                >비밀번호 초기화 하기</v-btn
              >
            </v-card-actions>
          </v-card>
