export const TEXT = [
  ...
  /* LANG.EN */
  {
    ...
    NOT_VALID_NUMBER: "Only numbers are allowed.",
  ...
  /* LANG.CN */
  {
    ALREADY_ADDED_TAG: "此标签已被添加。",
    EMPTY_IMAGES: "没有更多之前的图片了。",
    EXCEED_FILESIZE_LIMIT: "超出了允许的上传大小限制。",
    FAILED_LOAD_CONFIG: "加载看板设置失败。您可能没有写入的权限。",
    FAILED_LOAD_IMAGE: "加载之前上传的图片失败。",
    FAILED_LOAD_POST: "加载现有帖子失败。",
    FAILED_LOAD_TAGS: "加载推荐标签失败。",
    FAILED_MODIFY_POST: "修改现有帖子失败。",
    FAILED_REMOVE_FILE: "删除之前附加的文件失败。",
    FAILED_REMOVE_IMAGE: "删除图片失败。",
    FAILED_UPLOAD_IMAGE: "上传要添加到内容中的图片失败。",
    FAILED_WRITE_POST: "创建帖子失败。",
    FILESIZE_TOO_LARGE: "附件的大小必须小于此：",
    LOADED_ORIGINAL_POST: "成功加载原帖子。",
    MODIFIED_POST: "成功修改现有帖子。",
    NO_BOARD_ID: "看板ID不正确。这是一次无效的访问。",
    NO_RESPONSE: "无法收到服务器的响应。请联系管理员。",
    NOT_VALID_NUMBER: "只能输入数字。",
    REMOVED_FILE: "成功删除之前附加的文件。",
    REMOVED_IMAGE: "图片已被删除。",
    TOO_SHORT_CONTENT: "请至少输入3个字符的内容。",
    TOO_SHORT_TEXT: "请至少输入2个字符。",
    TOO_SHORT_TITLE: "请至少输入2个字符的标题。",
    WRITTEN_NEW_POST: "成功创建帖子。",
  },
]
Object.freeze(TEXT)
